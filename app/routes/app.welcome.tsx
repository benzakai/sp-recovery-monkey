        ...
        <div className="welcome-container">
            <div className="welcome-card">
                ...
                <div className="welcome-stat">
                    ...
                    <div className="welcome-stat-number">{getData?.length > 0 ? getData?.length : '0'}</div>
                    </div>
                    <div className="welcome-stat-label">Abandoned Carts</div>
                ...
                <div className="welcome-stat">
                    ...
                    <div className="welcome-stat-number">${recoveredSum.toFixed(2)}</div>
                    </div>
                    <div className="welcome-stat-label">Recovered Revenue</div>
                </div>
                </div>
                <div>
                <div className="welcome-stat">
                    ...
                    <div className="welcome-stat-number">${sum.toFixed(2)}</div>
                    </div>
                    <div className="welcome-stat-label">Unlockable Revenue</div>
                    <p>The amount of income waiting for recovery</p>
                </div>
                </div>
            </div>
        </div>
