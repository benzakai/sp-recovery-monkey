...
export default function Welcome() {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{ border: '1px solid black', width: '55%', borderRadius: '7px', backgroundColor: 'white', height: '30rem', padding: '60px' }}>
                <div style={{ height: '69px' }}>
                    <p style={{ fontSize: '69px', fontWeight: 'bold' }}>Welcome</p>
                </div>
                <div style={{ display: 'flex', flexDirection: 'row',marginBottom:'3rem',gap:'3rem' }}>
                    ...
                    <div style={{ width: '32%', marginRight: '15px' }}>
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '10px', justifyContent: 'start' }}>
                            ...
                            <div style={{ fontSize: '34px', fontWeight: 'bold', margin: '0 0 3% 0' }}>${recoveredSum.toFixed(2)}</div>
                        </div>

                        <div style={{ fontSize: '20px', margin: '6% 0 3% 0' }}>Recovered Revenue</div>
                    </div>
                </div>
                <div>
                    <div style={{ width: '32%', marginRight: '15px' }}>
